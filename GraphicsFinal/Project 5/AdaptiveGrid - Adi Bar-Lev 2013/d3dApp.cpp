...
void D3DApp::initDirect3D()
{
	...
	viewPort.Y = 0;
	*/
	//gd3dDevice->SetViewport( &viewPort);
}
...
LRESULT D3DApp::msgProc(UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
        switch (wParam)
        {
        case VK_ESCAPE:     enableFullScreenMode(false);    break;
        case 'F':           enableFullScreenMode(true);     break;
        case '1':           m_SolidFillStyle = !m_SolidFillStyle;     break;
        }
 		return 0;
	}
